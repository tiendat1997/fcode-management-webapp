...
var _collaPanel = __webpack_require__(19);

var _collaPanel2 = _interopRequireDefault(_collaPanel);
...
var _collaboration = __webpack_require__(30);

var _collaboration2 = _interopRequireDefault(_collaboration);

var _reactAutosuggest = __webpack_require__(31);
...
function renderSuggestion(suggestion) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'span',
			null,
			suggestion.studentCode
		)
	);
}

var CollaPanel = function (_React$Component) {
	_inherits(CollaPanel, _React$Component);

	function CollaPanel(props) {
		_classCallCheck(this, CollaPanel);

		var _this = _possibleConstructorReturn(this, (CollaPanel.__proto__ || Object.getPrototypeOf(CollaPanel)).call(this, props));
		...
		_this.loadCollaborations = _this.loadCollaborations.bind(_this);
		...
		_this.addCollaborator = _this.addCollaborator.bind(_this);

		return _this;
	}

	_createClass(CollaPanel, [{
		...
		key: 'loadCollaborations',
		value: function loadCollaborations() {
		...
		key: 'addCollaborator',
		value: function addCollaborator(username) {
			var projectId = $('#projectId').text();
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'button',
									{ className: 'btn btn-primary', onClick: this.addCollaborator.bind(this, this.state.value) },
									'Add collaborator'
								)
							)
						)
...
_reactDom2.default.render(_react2.default.createElement(CollaPanel, null), document.getElementById('react-panel'));
...
var Collaboration = function (_React$Component) {
	_inherits(Collaboration, _React$Component);
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'resume-content img-frame' },
						_react2.default.createElement('img', { className: 'img-profile-sm' })
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement('div', { className: 'subheading mb-3' })
					),
					_react2.default.createElement(
						'div',
