...
var _projectPanel = __webpack_require__(16);
...
var ProjectPanel = function (_React$Component) {
	_inherits(ProjectPanel, _React$Component);
...
_reactDom2.default.render(_react2.default.createElement(ProjectPanel, null), document.getElementById('react-project-panel'));
		...
		value: function render() {
			...
			if (this.props.project.categories != null) {
				this.props.project.categories.forEach(function (category) {
					categories.push(_react2.default.createElement(
						'span',
						{ className: 'badge badge-pill pink' },
						category.name
					));
				});
			}
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ href: this.props.project.project.link, target: '_blank' },
						'Fork to github'
					)
				)
			);
