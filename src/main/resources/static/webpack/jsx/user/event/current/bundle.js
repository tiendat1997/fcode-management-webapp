...
var _currentEventTree = __webpack_require__(16);

var _currentEventTree2 = _interopRequireDefault(_currentEventTree);
...
var CurEventTree = function (_React$Component) {
	_inherits(CurEventTree, _React$Component);

	function CurEventTree() {
		_classCallCheck(this, CurEventTree);

		var _this = _possibleConstructorReturn(this, (CurEventTree.__proto__ || Object.getPrototypeOf(CurEventTree)).call(this));

		_this.state = {
			events: []
		};
		_this.loadCurrentEventFromServer = _this.loadCurrentEventFromServer.bind(_this);
		return _this;
	}

	_createClass(CurEventTree, [{
		key: 'componentDidMount',
		value: function componentDidMount() {}
	}, {
		key: 'loadCurrentEventFromServer',
		value: function loadCurrentEventFromServer() {
			var request = $.ajax({
			...
			if (this.state.events.length > 0) {
				...
				list.push(_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'timeline-panel col-md-12' },
						_react2.default.createElement(
							'h4',
							{ className: 'col-md-12' },
							_react2.default.createElement(
...
_reactDom2.default.render(_react2.default.createElement(CurEventTree, null), document.getElementById('react-current-event'));
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						null,
						_react2.default.createElement('i', { className: 'fa fa-circle', id: '' })
					)
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'div',
						{ className: 'row timeline-heading' },
						_react2.default.createElement(
							'h4',
							{ className: 'col-md-8' },
							_react2.default.createElement(
						...
						_react2.default.createElement(
							'ul',
							{ className: 'list-inline list-social-icons mb-0 col-md-4 text-right' },
							_react2.default.createElement(
								'li',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										{ className: 'fa-stack fa-sm' },
										_react2.default.createElement('i', { className: 'fa fa-circle fa-stack-2x' }),
										_react2.default.createElement('i', { className: 'fa fa-google fa-stack-1x fa-inverse' })
									)
								)
							)
						)
