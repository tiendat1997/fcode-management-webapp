...
var _memberPanel = __webpack_require__(16);
...
var _memberTable = __webpack_require__(28);

var _memberTable2 = _interopRequireDefault(_memberTable);
...
var MemberPanel = function (_React$Component) {
	...
	function MemberPanel(props) {
		_classCallCheck(this, MemberPanel);

		var _this = _possibleConstructorReturn(this, (MemberPanel.__proto__ || Object.getPrototypeOf(MemberPanel)).call(this, props));
		...
		_this.loadMembersFromServer = _this.loadMembersFromServer.bind(_this);
		return _this;
	}
		...
		value: function render() {
			...
			if (this.state.page != null) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_memberTable2.default, {
...
_reactDom2.default.render(_react2.default.createElement(MemberPanel, null), document.getElementById('member-panel-react'));
...
var _memberRow = __webpack_require__(29);

var _memberRow2 = _interopRequireDefault(_memberRow);
